<%-- 
    ...
    Created on : Jul 27, 2018, 3:10:55 PM
    Author     : Asif
--%>
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form action="RegistrationServlet" method="GET">
                ...
                <button type="submit" Class="btn btn-success" name="button" value="signUpbtn">Sign Up</button>
                <button type="submit"class="btn btn-default" name="button" value="backbtn">Back</button>
